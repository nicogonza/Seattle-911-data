...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["low", "medium", "high","higher"]).range(["#d84b2a","#cc9966", "#beccae", "#7aa25c"]);
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content += "<span class=\"name\">School District:</span><span class=\"value\"> $" + (addCommas(data.org)) + "</span><br/>";
  ...
  $(function() {
    ...
    return d3.csv("data/data_Bubble.csv", render_vis);
  });
