...
class BubbleChart
  constructor: (data) ->
    ...
    @fill_color = d3.scale.ordinal()
      .domain(["low", "medium", "highest","high"])
      .range(["#99341c", "#d84b2a", "#1c9954","#2ad877"])
  ...
  show_details: (data, i, element) =>
    ...
    content = "<span class=\"name\">City:</span><span class=\"value\"> #{data.name}</span><br/>"
    content +="<span class=\"name\">Amount:</span><span class=\"value\"> $#{addCommas(data.value)}</span><br/>"
    content +="<span class=\"name\">School District:</span><span class=\"value\"> #{data.org}</span><br/>"
    content +="<span class=\"name\">Poverty Level:</span><span class=\"value\"> #{data.group}</span><br/>"
...
$ ->
  ...
  d3.csv "data/data_Bubble.csv", render_vis
